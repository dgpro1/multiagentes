...
- [WhatsApp](en/whatsapp.md) — Link one or more numbers per client through a self-hosted Evolution API instance and hand off to a human.
...
- [WhatsApp](es/whatsapp.md) — Vincula uno o más números por cliente con una instancia propia de Evolution API y pasa a control humano.
