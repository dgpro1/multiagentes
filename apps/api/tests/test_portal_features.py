...
GATED = [
    ...
    ("GET", "/conversations/{id}/scheduled-messages", ["inbox"]),
    ("POST", "/conversations/{id}/scheduled-messages", ["inbox"]),
    ("PATCH", "/conversations/{id}/scheduled-messages/{id}", ["inbox"]),
    ("DELETE", "/conversations/{id}/scheduled-messages/{id}", ["inbox"]),
